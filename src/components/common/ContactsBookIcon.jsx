...
const ContactsBookIcon = props => {
  return (
    <SvgIcon viewBox="0 0 484.6 484.6" {...props}>
      <path
        d="M407.1,442c0,7.8-6.4,14.2-14.2,14.2H64.3c-7.8,0-14.2-6.4-14.2-14.2v-5.8H356c15.6,0,28.3-12.7,28.3-28.3V28.3
